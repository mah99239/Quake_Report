...
public class EarthquakeActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<List<EarthQuake>> {
    ...
    private earthquakeadbater mAdapter;
    ...
    private class Earthquakeasynctack extends AsyncTask<String, Void, List<EarthQuake>> {
    ...
    public static class QueryUtils {
         ...
         */
    private static List<EarthQuake> extractEarthquakesJson(String earthquakeJSON) {
    ...
    public static List<EarthQuake> fetchEarthquakeData(String requestUrl) {
        ...
        List<EarthQuake> EarthQuakes = extractEarthquakesJson(jsonResponse);
